...
/*   Updated: 2024/12/16 18:15:44 by cabo-ram         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	rotate(char *type, t_stack *stack)
{
	...
	if (ft_strncmp(type, "ra", 3) == 0 && stack->sizea > 0)
	{
		temp = stack->a[0];
	...
	else if (ft_strncmp(type, "rb", 3) == 0 && stack->sizeb > 0)
	{
		temp = stack->b[0];
...
void	reverse_rotate(char *type, t_stack *stack)
{
	...
	if (ft_strncmp(type, "rra", 4) == 0 && stack->sizea > 0)
	{
	...
	else if (ft_strncmp(type, "rrb", 4) == 0 && stack->sizeb > 0)
	{
